// Static ITU-T calling-code reference data — no Supabase import, safe for
// client components. Flags are computed from the ISO 3166-1 alpha-2 code
// (regional indicator symbols), not a separate image/data dependency.
